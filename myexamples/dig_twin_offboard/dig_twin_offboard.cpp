/**
 * @file dig_twin_offboard.cpp
 * @brief Example that demonstrates offboard velocity control in local NED and
 * body coordinates
 *
 * @authors Author: Anton Hristozov, Software Engineering Institute 
 */
...
int main(int argc, char** argv)
{
    ...
    std::cout << GREEN_CONSOLE_TEXT << "Starting offboard app " << argv[0] << std::endl << std::endl;
